      ...
      >
        <div className='space-y-2'>
          <div className="relative">
            ...
            />
            <div className={`rounded-s absolute -bottom-2 translate-y-full z-10 w-full bg-primary transition-opacity ease-in-out duration-150 ${showTelegramUserResult ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
              {
                telegramUser ?
                <Contact node={{
                  //@ts-ignore
